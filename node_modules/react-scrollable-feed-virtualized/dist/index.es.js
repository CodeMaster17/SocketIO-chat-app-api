...
var ScrollableFeedVirtualized = /** @class */ (function (_super) {
    ...
    function ScrollableFeedVirtualized(props) {
        ...
        _this.childWrapperRef = createRef();
        _this.topRef = createRef();
    ...
    ScrollableFeedVirtualized.prototype.render = function () {
        ...
        return (createElement("div", { className: joinedClassName, ref: this.wrapperRef, onScroll: this.handleScroll, onKeyDown: this.handleKeyDown, onWheel: this.handleMouseWheel, onMouseDown: this.handleMouseDown, tabIndex: 0 },
            createElement("div", { ref: this.childWrapperRef, style: { height: childWrapperHeight + "px" } },
                createElement("div", { ref: this.topRef }),
                items,
